...
export const DEFAULT_CATEGORIES = [
  ...
  { configType: 'category', key: 'FUEL',          label: 'Fuel',          icon: 'fuel',          isBuiltin: true, order: 3 },
  { configType: 'category', key: 'TRAVEL',        label: 'Travel',        icon: 'car',           isBuiltin: true, order: 4 },
  { configType: 'category', key: 'SUBSCRIPTIONS', label: 'Subscriptions', icon: 'smartphone',    isBuiltin: true, order: 5 },
  { configType: 'category', key: 'MEDICAL',       label: 'Medical',       icon: 'pill',          isBuiltin: true, order: 6 },
  { configType: 'category', key: 'ENTERTAINMENT', label: 'Entertainment', icon: 'film',          isBuiltin: true, order: 7 },
  { configType: 'category', key: 'UTILITIES',     label: 'Utilities',     icon: 'lightbulb',     isBuiltin: true, order: 8 },
  { configType: 'category', key: 'OTHER',          label: 'Other',         icon: 'tag',           isBuiltin: true, order: 9 },
  // Investment categories
  { configType: 'category', key: 'STOCKS',         label: 'Stocks',        icon: 'landmark',      isBuiltin: true, order: 10 },
  { configType: 'category', key: 'MUTUAL_FUNDS',   label: 'Mutual Funds',  icon: 'line-chart',    isBuiltin: true, order: 11 },
  { configType: 'category', key: 'GOLD',           label: 'Gold',          icon: 'gem',           isBuiltin: true, order: 12 },
  { configType: 'category', key: 'FIXED_DEPOSIT',  label: 'Fixed Deposit', icon: 'piggy-bank',    isBuiltin: true, order: 13 },
];
